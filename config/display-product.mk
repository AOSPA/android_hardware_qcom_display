...
$(call soong_config_set,sdmhwc2,excludes_display_pp,true)
endif

ifeq ($(TARGET_EXCLUDES_MULTI_DISPLAY),true)
$(call soong_config_set,sdmhwc2,excludes_multi_display,true)
endif

ifeq ($(TARGET_HAS_WIDE_COLOR_DISPLAY),true)
$(call soong_config_set,sdmhwc2,has_wide_display,true)
endif
